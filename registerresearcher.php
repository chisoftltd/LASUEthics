...
if (isset($_POST['signup'])) {
    ...
    if (!$error) {
        if (mysqli_query($link, "INSERT INTO researchers(name,email,password) VALUES('" . $name . "', '" . $email . "', '" . md5($password) . "')")) {
...
<html>
<head>
    <title>LASUEthics | Researcher Registration</title>
...
<nav class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="registerresearcher.php">LASUEthics | Researcher Registration</a>
        </div>
        <!-- menu items -->
