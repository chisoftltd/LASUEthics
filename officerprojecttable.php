...
<html>
<head>
    <title>LASUEthics | Officer Research Ethics Database</title>
...
<nav class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="officerprojecttable.php">LASUEthics | Officer Research Ethics Database</a>
        </div>
...
<div class="container">
    ...
    if (mysqli_num_rows($result2)) {
        ...
        while ($row2 = mysqli_fetch_array($result2)) {
            ...
            echo "<td><a href='ethicsofficer.php?p={$row2['id']}'> " . $row2[projecttopic] . "</a></td>";
